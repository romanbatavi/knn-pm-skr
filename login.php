										...
										<form action="ceklogin" method="post" id="login-form">
											<div class="form-group">
												<div class="float-label float-label-lg">
													<input class="form-control form-control-lg" type="text" id="email" name="username" placeholder="Please insert your Username"><label for="email">Username</label>
												</div>
											</div>
											<div class="form-group">
												<div class="float-label float-label-lg">
											...
											<button type="submit" class="btn btn-label-primary btn-lg btn-block btn-pill">Login</button>
										</form>
									</div>
								</div>
							</div>
