<div class="container-fluid">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="alamat_lowongan" value="<?= $alamat2 ?>" />
                <input class="form-control" type="hidden" name="id_user" value="<?= $id_user2 ?>" />

            </div>
            <div class="form-group">
                <label>Email Lowongan <span class="text-danger">*</span></label>
                <input class="form-control" type="email" name="email_lowongan" value="<?= $email2 ?>" />
            </div>
           
            <div class="form-group">
                <label>No Lowongan <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="no_lowongan" value="<?= $no2 ?>" />
            </div>
            <div class="form-group">
