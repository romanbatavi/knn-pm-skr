...
?>
							<div class="portlet-body">
								<p>
                                    Lengkapi Data Berikut Ini Untuk Mengetahui Rekomendasi Lowker untuk Anda.
								</p>
								<hr>
            ...
            foreach ($atribut as $key => $val) : ?>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <?php else : ?>
                            <input class="form-control" type="text" id="<?= $val->id_atribut ?>" min="<?= $val->min ?>" max="<?= $val->max ?>" name="nilai[<?= $key ?>]" value="<?= $_POST['nilai'][$key] ?>" />
                        <?php endif ?>
