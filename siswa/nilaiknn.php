                ...
                <div class="modal-body">
                    <form method="post" action="">
                        ...
                        <?php
                            ...
                            $db  = new database();
                            $kon = $db->connect(); $qcek = $kon->query("select * from user WHERE status = 'ya' AND hak_akses = 'siswa'  AND id_user NOT IN (SELECT $id_user2 FROM user)"); 
						...
						<div class="form-group row">
                            ...
                            <input type="hidden" class="form-control"  name="id_user2" value="<?php echo $id_user2?>" required>
