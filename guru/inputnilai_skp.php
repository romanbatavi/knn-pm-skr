<div class="container-fluid">
    ...
    function setGappkn(){
        ...
        var ips = document.getElementById("nilai_bobot_kd").value;
        var ipa = document.getElementById("nilai_bobot_pe").value;
        var pkn = document.getElementById("nilai_bobot_krj").value;


        var cf = (parseFloat(ips) + parseFloat(ipa)) / 2;
        var sf = parseFloat(pkn) / 1;
        var nt = (cf * 0.2) + (sf * 0.8);
