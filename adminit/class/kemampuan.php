...
class kemampuan {
  ...
  $query = $kon->query("SELECT * FROM pm_kemampuan, user where pm_kemampuan.id_user=user.id_user");
	...
	function input($angkatan, $id_user, $nilai_tg, $target_tg, $selisih_tg, $nilai_bobot_tg,
								 ...
								 $nilai_cf_A2, $nilai_sf_A2, $nilai_tot_A2)
	{
		...
		$query = "INSERT INTO pm_kemampuan (angkatan, id_user, nilai_tg, target_tg, selisih_tg, nilai_bobot_tg,
																		nilai_st, target_st, selisih_st, nilai_bobot_st,
						 												nilai_phs, target_phs, selisih_phs, nilai_bobot_phs,
																		nilai_cf_A2, nilai_sf_A2, nilai_tot_A2)
						 VALUES ('$angkatan', '$id_user', '$nilai_tg', '$target_tg', '$selisih_tg','$nilai_bobot_tg',
							 			 '$nilai_st', '$target_st', '$selisih_st', '$nilai_bobot_st',
							 		 	 '$nilai_phs', '$target_phs', '$selisih_phs', '$nilai_bobot_phs',
									 	 '$nilai_cf_A2', '$nilai_sf_A2', '$nilai_tot_A2')";
